        ...
        <div className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
          <div>
            <SectionHeading
              ...
              description="Практико-ориентированное обучение по эндодонтии, основанное на реальных клинических случаях, диагностике и принятии решений в сложных ситуациях."
            />
